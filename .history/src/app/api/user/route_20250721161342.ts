...
export async function GET() {
  ...
  // Appel à l'API externe pour récupérer l'utilisateur par son id
  const apiUrl = `${process.env.NEXT_PUBLIC_MON_API}/users/users/${userId}`;
  console.log("[/api/user] Fetching:", apiUrl);
